...
{
    int pilihannn;
    cout << "Menu Sorting Daftar Barang Menurut Harga : " <<endl;
...
//     if (isFull())
//     {
//         cout << "Antrina Sudah Penuh" <<endl;
//     }
//     else {
//         string input;
//         cout << "Masukkan Data Ke Queue : ";cin >> input;
//         queue.front = 0;
//         queue.rear++;
...
//         for (int x = queue.front;x <= queue.rear;x++)
//         {
//             queue.Data[x] = queue.Data[x+1];
//         }
//         queue.rear--;
//     }
// }
...
//         queue.front = -1;
//         queue.rear = -1;
//         cout << "Daftar Antrian Sudah Di Kosongkan" <<endl;
//     }
// }
